...
<TestClass()> Public Class TestJoins
    ...
    Public Sub TestMakeSQLStmt()
        ...
        j.MakeSQLStmt(schema, gen, Nothing, Nothing, Nothing, Nothing)
    End Sub
    ...
    Public Sub TestMakeSQLStmt3()
        ...
        Dim gen As New SQLGenerator
        j.MakeSQLStmt(schema, gen, Nothing, almgr, Nothing, Nothing)
    End Sub
    ...
    Public Sub TestMakeSQLStmt4()
        ...
        j.MakeSQLStmt(schema, gen, Nothing, almgr, pmgr, Nothing)
    End Sub
    ...
    Public Sub TestMakeSQLStmt5()
        ...
        Assert.AreEqual(" join table1 t1 on t2.id = @p1", j.MakeSQLStmt(schema, gen, Nothing, almgr, pmgr, Nothing))
    ...
    Public Sub TestMakeSQLStmt6()
        ...
        Assert.AreEqual(" join table1 t1 on t2.id = 1", j.MakeSQLStmt(schema, gen, Nothing, almgr, pmgr, Nothing))

        Assert.AreEqual(0, pmgr.Params.Count)

        Assert.AreEqual(" join table1 t1 on t2.id = 1", j.MakeSQLStmt(schema, gen, Nothing, almgr, Nothing, Nothing))
    End Sub
    ...
    Public Sub TestReplaceFilter()
        ...
        Assert.AreEqual(" join table1 t2 on (t2.id = t1.id and t2.s = @p1)", j.MakeSQLStmt(schema, gen, Nothing, almgr, pmgr, Nothing))
        ...
        Assert.AreEqual(" join table1 t2 on (t2.id = @p2 and t2.s = @p1)", j.MakeSQLStmt(schema, gen, Nothing, almgr, pmgr, Nothing))
    ...
    Public Sub TestMakeSQLStmt8()
        ...
        Assert.AreEqual(" full join table1 t1 on t2.id = @p1", j.MakeSQLStmt(schema, gen, Nothing, almgr, pmgr, Nothing))
        ...
        Assert.AreEqual(" left join table1 t1 on t2.id = @p2", j.MakeSQLStmt(schema, gen, Nothing, almgr, pmgr, Nothing))
        ...
        Assert.AreEqual(" right join table1 t1 on t2.id = @p3", j.MakeSQLStmt(schema, gen, Nothing, almgr, pmgr, Nothing))
        ...
        Assert.AreEqual(" cross join table1 t1 on t2.id = @p4", j.MakeSQLStmt(schema, gen, Nothing, almgr, pmgr, Nothing))
    End Sub
End Class
...
<TestClass()> Public Class TestCondition
    ...
    Public Sub TestMakeSQLStmt()
        ...
        c.MakeQueryStmt(Nothing, Nothing, Nothing, Nothing, Nothing)
    End Sub
    ...
    Public Sub TestMakeSQLStmt2()
        ...
        Dim schema As New Worm.ObjectMappingEngine("1")
        Dim gen As New SQLGenerator
        c.MakeQueryStmt(schema, gen, Nothing, Nothing, Nothing)
    End Sub
    ...
    Public Sub TestMakeSQLStmt3()
        ...
        Dim gen As New SQLGenerator
        c.MakeQueryStmt(schema, gen, Nothing, almgr, Nothing)
    End Sub
    ...
    Public Sub TestMakeSQLStmt4()
        ...
        Dim gen As New SQLGenerator
        Dim pmgr As New ParamMgr(gen, "p")
        Assert.AreEqual("t1.id = @p1", c.MakeQueryStmt(schema, gen, Nothing, almgr, pmgr))
    End Sub
    ...
    Public Sub TestMakeSQLStmt5()
        ...
        Dim gen As New SQLGenerator
        Dim pmgr As New ParamMgr(gen, "p")
        Assert.AreEqual("(t1.id = @p1 or t2.id > @p2)", c.MakeQueryStmt(schema, gen, Nothing, almgr, pmgr))
    End Sub
    ...
    Public Sub TestReplace()
        ...
        Assert.AreEqual("(t1.id = @p1 or t2.id <> @p3)", c2.MakeQueryStmt(schema, gen, Nothing, almgr, pmgr))

        Dim c3 As New Condition(c, f3, ConditionOperator.And)

        Assert.AreEqual("((t1.id = @p1 or t2.id > @p2) and t2.id <> @p3)", c3.MakeQueryStmt(schema, gen, Nothing, almgr, pmgr))

        Dim c4 As IFilter = CType(c3.ReplaceFilter(f2, f3), IFilter)

        Assert.AreEqual("((t1.id = @p1 or t2.id <> @p3) and t2.id <> @p3)", c4.MakeQueryStmt(schema, gen, Nothing, almgr, pmgr))

        Dim c5 As IFilter = CType(c3.ReplaceFilter(f3, c4), IFilter)

        Assert.AreEqual("((t1.id = @p1 or t2.id > @p2) and ((t1.id = @p1 or t2.id <> @p3) and t2.id <> @p3))", c5.MakeQueryStmt(schema, gen, Nothing, almgr, pmgr))

        Dim c6 As IFilter = CType(c5.ReplaceFilter(f3, Nothing), IFilter)

        Assert.AreEqual("((t1.id = @p1 or t2.id > @p2) and (t1.id = @p1 or t2.id <> @p3))", c6.MakeQueryStmt(schema, gen, Nothing, almgr, pmgr))
    End Sub
    ...
    Public Sub TestRemove()
        ...
        Assert.AreEqual("(1 = 0 or t2.id > @p2)", tf.MakeQueryStmt(schema, gen, Nothing, almgr, pmgr))
        ...
        Assert.AreEqual("((t1.id = @p1 or t2.id > @p2) and 1 = 1)", tf.MakeQueryStmt(schema, gen, Nothing, almgr, pmgr))

        c3 = New Condition(New Condition(f, f2, ConditionOperator.Or), f3, ConditionOperator.And)
        tf = c3.RemoveFilter(f2)
        Assert.AreEqual("((t1.id = @p1 or 1 = 0) and t2.id <> @p3)", tf.MakeQueryStmt(schema, gen, Nothing, almgr, pmgr))
    End Sub
    ...
    Public Sub TestReplace3()
        ...
        Assert.AreEqual("(t1.id = @p1 or t2.name = @p2)", c.MakeQueryStmt(schema, gen, Nothing, almgr, pmgr))
    End Sub
...
<TestClass()> Public Class TestFilters
    ...
    Public Sub TestMakeSQLStmt()
        ...
        f.MakeQueryStmt(CType(Nothing, Worm.ObjectMappingEngine), Nothing, Nothing, Nothing, Nothing)
    End Sub
    ...
    Public Sub TestMakeSQLStmt2()
        ...
        f.MakeQueryStmt(schema, Nothing, Nothing, Nothing, Nothing)
    End Sub
    ...
    Public Sub TestMakeSQLStmt3()
        ...
        Assert.AreEqual("t1.id >= @p1", f.MakeQueryStmt(schema, gen, Nothing, almgr, pmgr))
        Assert.AreEqual(1, pmgr.Params.Count)
