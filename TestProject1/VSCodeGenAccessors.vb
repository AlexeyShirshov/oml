...
Friend Class Worm_Orm_OrmReadOnlyDBManagerAccessor
    ...
    Friend Shared Function CreatePrivate(ByVal schema As Global.Worm.Database.SQL2000Generator, ByVal connectionString As String) As Global.Worm.Database.OrmReadOnlyDBManager
        Dim args() As Object = New Object() {schema, connectionString}
        Dim priv_obj As Microsoft.VisualStudio.TestTools.UnitTesting.PrivateObject = New Microsoft.VisualStudio.TestTools.UnitTesting.PrivateObject(GetType(Global.Worm.Database.OrmReadOnlyDBManager), New System.Type() {GetType(Global.Worm.Database.SQL2000Generator), GetType(String)}, args)
    ...
    Friend Function FindConnected(ByVal ct As Global.System.Type, ByVal selectedType As Global.System.Type, ByVal filterType As Global.System.Type, ByVal connectedFilter As Global.Worm.Criteria.Core.IEntityFilter, ByVal filter As Global.Worm.Criteria.Core.IEntityFilter, ByVal withLoad As Boolean, ByVal sort As SortExpression) As Global.System.Collections.IList
        Dim args() As Object = New Object() {ct, selectedType, filterType, connectedFilter, filter, withLoad, sort}
        Dim ret As Global.System.Collections.IList = CType(m_privateObject.Invoke("FindConnected", New System.Type() {GetType(Global.System.Type), GetType(Global.System.Type), GetType(Global.System.Type), GetType(Global.Worm.Criteria.Core.IEntityFilter), GetType(Global.Worm.Criteria.Core.IEntityFilter), GetType(Boolean), GetType(SortExpression)}, args), Global.System.Collections.IList)
        Return ret
    End Function
    ...
    Friend Overloads Function GetFilters(ByVal ids As System.Collections.Generic.List(Of Object), ByVal fieldName As String, ByVal almgr As AliasMgr, ByVal params As Global.Worm.Database.ParamMgr, ByVal original_type As Global.System.Type, ByVal idsSorted As Boolean) As System.Collections.Generic.IEnumerable(Of Pair(Of String, Integer))
        Dim args() As Object = New Object() {ids, New ObjectProperty(original_type, fieldName), almgr, params, idsSorted}
        Dim ret As System.Collections.Generic.IEnumerable(Of Pair(Of String, Integer)) = CType(m_privateObject.Invoke("GetFilters", New System.Type() {GetType(System.Collections.Generic.List(Of Object)), GetType(ObjectProperty), GetType(AliasMgr), GetType(Global.Worm.Database.ParamMgr), GetType(Boolean)}, args), System.Collections.Generic.IEnumerable(Of Pair(Of String, Integer)))
        Return ret
    End Function
