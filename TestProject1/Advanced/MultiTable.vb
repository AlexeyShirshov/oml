...
Public Class TestMultiTable
    ...
    Public Sub TestLoad()
        ...
        Using mgr As OrmReadOnlyDBManager = tm.CreateManager(GetSchema("en"))
            m2 = New QueryCmd().GetByID(Of MultiTable)(1, GetByIDOptions.EnsureExistsInStore, mgr)
        ...
        Using mgr As OrmReadOnlyDBManager = tm.CreateManager(GetSchema("ru"))
            m1 = New QueryCmd().GetByID(Of MultiTable)(1, GetByIDOptions.EnsureExistsInStore, mgr)
