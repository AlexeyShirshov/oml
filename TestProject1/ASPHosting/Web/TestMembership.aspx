...
#If UseUserInstance Then
            ...
            Return New OrmReadOnlyDBManager("Server=.\sqlexpress;AttachDBFileName='" & path & "';User Instance=true;Integrated security=true;Database=wormtest;", New Worm.ObjectMappingEngine("1"), New SQL2000Generator, New OrmCache)
#Else
