...
#If UseUserInstance Then
        ...
        Dim m As OrmManager = New OrmDBManager("Server=.\sqlexpress;AttachDBFileName='" & path & "';User Instance=true;Integrated security=true;", New ObjectMappingEngine("1"), New SQL2000Generator, OrmCache)
#Else
