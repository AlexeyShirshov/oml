...
Public Class MyRoles
    ...
    Protected Overloads Overrides Sub DeleteRole(ByVal mgr As Worm.Orm.OrmDBManager, ByVal role As Worm.Orm.OrmBase, ByVal cascase As Boolean)
        If cascase Then
    ...
    Protected Overrides Function FindRoles(ByVal mgr As Worm.Orm.OrmDBManager, ByVal f As CriteriaLink) As System.Collections.IList
        Return CType(mgr.Find(Of MyRole)(f, Nothing, WithLoad), System.Collections.IList)
    End Function

    Protected Overrides Function GetRoleByName(ByVal mgr As Worm.Orm.OrmDBManager, ByVal name As String, ByVal createIfNotExist As Boolean) As Worm.Orm.OrmBase
        ...
        Dim col As IList = FindRoles(mgr, New Criteria(t).Field(_rolenameField).Eq(name))
        If col.Count > 1 Then
