...
<System.Data.Linq.Mapping.DatabaseAttribute(Name:="WormTest")>  _
...
Partial Public Class Table
	...
	<Column(Storage:="_col", DbType:="Bit")>  _
	...
	<Column(Storage:="_uq", DbType:="UniqueIdentifier NOT NULL")>  _
	...
	<Association(Name:="Table2_Table", Storage:="_Table2", ThisKey:="id", IsForeignKey:=true)>  _
...
<Table(Name:="dbo.Tables1to3Relation")>  _
Partial Public Class Tables1to3Relation
	...
	<Column(Storage:="_table1", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_table3", DbType:="Int NOT NULL")>  _
	...
	<Association(Name:="Table1_Tables1to3Relation", Storage:="_Table11", ThisKey:="table1", IsForeignKey:=true)>  _
	...
	<Association(Name:="Table3_Tables1to3Relation", Storage:="_Table31", ThisKey:="table3", IsForeignKey:=true)>  _
...
Partial Public Class Table1
	...
	<Column(Storage:="_code", DbType:="Int")>  _
	...
	<Column(Name:="enum", Storage:="_enum", DbType:="TinyInt")>  _
	...
	<Column(Storage:="_enum_str", DbType:="VarChar(50)")>  _
	...
	<Column(Storage:="_dt", DbType:="DateTime NOT NULL")>  _
	...
	<Association(Name:="Table1_Tables1to3Relation", Storage:="_Tables1to3Relations", OtherKey:="table1")>  _
	...
	<Association(Name:="Table1_Table10", Storage:="_Table10s", OtherKey:="table1_id")>  _
	...
	<Association(Name:="Table1_Table2", Storage:="_Table2s", OtherKey:="table1_id")>  _
...
Partial Public Class Table10
	...
	<Column(Storage:="_table1_id", DbType:="Int")>  _
	...
	<Association(Name:="Table1_Table10", Storage:="_Table1", ThisKey:="table1_id", IsForeignKey:=true)>  _
...
Partial Public Class Table1to1
	...
	<Column(Storage:="_table1_back", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_k", DbType:="VarChar(50)")>  _
...
Partial Public Class Table2
	...
	<Column(Storage:="_blob", DbType:="VarBinary(MAX)", UpdateCheck:=UpdateCheck.Never)>  _
	...
	<Column(Storage:="_m", DbType:="Money")>  _
	...
	<Column(Storage:="_dt2", DbType:="DateTime")>  _
	...
	<Association(Name:="Table2_Table", Storage:="_Table", ThisKey:="id", IsUnique:=true, IsForeignKey:=false)>  _
	...
	<Association(Name:="Table1_Table2", Storage:="_Table1", ThisKey:="table1_id", IsForeignKey:=true)>  _
	Public Property Table1() As Table1
		Get
			Return Me._Table1.Entity
		End Get
...
Partial Public Class Table3
	...
	<Column(Storage:="_ref_id", DbType:="Int NOT NULL", UpdateCheck:=UpdateCheck.Never)>  _
	...
	<Column(Storage:="_code", DbType:="TinyInt NOT NULL", UpdateCheck:=UpdateCheck.Never)>  _
	...
	<Column(Storage:="_v", AutoSync:=AutoSync.Always, DbType:="rowversion NOT NULL", CanBeNull:=false, IsDbGenerated:=true, IsVersion:=true, UpdateCheck:=UpdateCheck.Never)>  _
	...
	<Column(Storage:="_x", DbType:="Xml", UpdateCheck:=UpdateCheck.Never)>  _
	...
	<Association(Name:="Table3_Tables1to3Relation", Storage:="_Tables1to3Relations", OtherKey:="table3")>  _
	Public Property Tables1to3Relations() As EntitySet(Of Tables1to3Relation)
		Get
			Return Me._Tables1to3Relations
		End Get
