...
Friend Class Worm_Orm_OrmReadOnlyDBManagerAccessor
    ...
    Friend Function FindConnected(ByVal ct As Global.System.Type, ByVal selectedType As Global.System.Type, ByVal filterType As Global.System.Type, ByVal connectedFilter As Global.Worm.Criteria.Core.IEntityFilter, ByVal filter As Global.Worm.Criteria.Core.IEntityFilter, ByVal withLoad As Boolean, ByVal sort As Sort) As Global.System.Collections.IList
        Dim args() As Object = New Object() {ct, selectedType, filterType, connectedFilter, filter, withLoad, sort}
        Dim ret As Global.System.Collections.IList = CType(m_privateObject.Invoke("FindConnected", New System.Type() {GetType(Global.System.Type), GetType(Global.System.Type), GetType(Global.System.Type), GetType(Global.Worm.Criteria.Core.IEntityFilter), GetType(Global.Worm.Criteria.Core.IEntityFilter), GetType(Boolean), GetType(Sort)}, args), Global.System.Collections.IList)
        Return ret
    End Function
