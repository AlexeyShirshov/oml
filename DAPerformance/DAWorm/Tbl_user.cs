...
namespace DAWorm
{
	...
	public class Tbl_user : Worm.Orm.OrmBaseT<Tbl_user>, Worm.Orm.Meta.IOrmEditable<Tbl_user>
	{
		...
		public Tbl_user(int id, Worm.Cache.OrmCacheBase cache, Worm.QueryGenerator schema) : 
		...
		#region Properties
		[Worm.Orm.Meta.ColumnAttribute(DAWorm.Tbl_user.Properties.First_name)]
		public virtual string First_name
		{
			get
			{
using (this.Read(DAWorm.Tbl_user.Properties.First_name))
{
    return this._first_name;
			...
			set
			{
using (this.Write(DAWorm.Tbl_user.Properties.First_name))
{
    this._first_name = value;
		...
		[Worm.Orm.Meta.ColumnAttribute(DAWorm.Tbl_user.Properties.Last_name)]
		public virtual string Last_name
		{
			get
			{
using (this.Read(DAWorm.Tbl_user.Properties.Last_name))
{
    return this._last_name;
			...
			set
			{
using (this.Write(DAWorm.Tbl_user.Properties.Last_name))
{
    this._last_name = value;
		...
		public override void SetValue(System.Reflection.PropertyInfo pi, Worm.Orm.Meta.ColumnAttribute c, object value)
		{
			...
			if (DAWorm.Tbl_user.Properties.First_name.Equals(fieldName))
			{
				this._first_name = ((string)(value));
				return;
			}
			if (DAWorm.Tbl_user.Properties.Last_name.Equals(fieldName))
			{
		...
		{
			if (DAWorm.Tbl_user.Properties.First_name.Equals(propAlias))
			{
				return this.First_name;
			}
			if (DAWorm.Tbl_user.Properties.Last_name.Equals(propAlias))
			{
