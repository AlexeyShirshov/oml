...
Public Class TestDistinct
    ...
    Public Sub TestSelect()
        ...
        Using mgr As OrmReadOnlyDBManager = TestManagerRS.CreateManagerShared(s)
            ...
            Dim c As ICollection(Of Table1) = mgr.FindDistinct(Of Table1)(joins, Nothing, Nothing, SortType.Asc, True)
    ...
    Public Sub TestSelect2()
        ...
        Using mgr As OrmReadOnlyDBManager = TestManagerRS.CreateManagerShared(s)
            ...
            Dim c As ICollection(Of Table1) = mgr.FindDistinct(Of Table1)(s.GetM2MRelation(GetType(Table1), _
                t, True), Nothing, Nothing, SortType.Asc, True)
    ...
    Public Sub TestSelect3()
        ...
        Using mgr As OrmReadOnlyDBManager = TestManagerRS.CreateManagerShared(s)
            ...
            Dim t As Type = s.GetTypeByEntityName("Table3")
            Dim f As New OrmFilter(t, "Code", New Worm.TypeWrap(Of Object)(10), FilterOperation.LessEqualThan)
            'Dim join As New OrmJoin(tbl, JoinType.Join, f)
            ...
            Dim c As ICollection(Of Table1) = mgr.FindDistinct(Of Table1)(s.GetM2MRelation(GetType(Table1), t, True), f, Nothing, SortType.Asc, True)
    ...
    Public Sub TestSelect4()
        ...
        Using mgr As OrmReadOnlyDBManager = TestManagerRS.CreateManagerShared(s)
            Dim t As Type = s.GetTypeByEntityName("Table3")
            Dim c As ICollection(Of Table1) = mgr.FindDistinct(Of Table1)(s.GetM2MRelation(GetType(Table1), _
                t, True), Nothing, Nothing, SortType.Asc, False)
    ...
    Public Sub TestSelect5()
        ...
        Using mgr As OrmReadOnlyDBManager = TestManagerRS.CreateManagerShared(s)
            ...
            Dim c As ICollection(Of Table1) = mgr.FindDistinct(Of Table1)(joins, Nothing, Nothing, SortType.Asc, False)
