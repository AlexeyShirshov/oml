...
namespace OrmCodeGenLib.Descriptors
{
	public class PropertyDescription : ICloneable
	{
		...
		public PropertyDescription(string name)
			: this(name, null, null, null, null, null, null, false, default(AccessLevel), default(AccessLevel), true, false)
		{
		}
		...
		public PropertyDescription(string name, string alias, string[] attributes, string description, TypeDescription type, string fieldname, TableDescription table, AccessLevel fieldAccessLevel, AccessLevel propertyAccessLevel)
			: this(name, alias, attributes, description, type, fieldname, table, false, fieldAccessLevel, propertyAccessLevel, false, false)
		{
		}

		internal PropertyDescription(string name, string alias, string[] attributes, string description, TypeDescription type, string fieldname, TableDescription table, bool fromBase, AccessLevel fieldAccessLevel, AccessLevel propertyAccessLevel, bool isSuppressed, bool isRefreshed)
		{
			_name = name;
