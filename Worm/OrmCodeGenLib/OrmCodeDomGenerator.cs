...
namespace OrmCodeGenLib
{
	public class OrmCodeDomGenerator
	{
		...
		public Dictionary<string, CodeCompileUnit> GetEntityDom(string entityId, OrmCodeDomGeneratorSettings settings)
		{
			...
			CreateProperties(createobjectMethod, entity, entityClass, settings, setvalueMethod, copyMethod, propertiesClass);
		...
		private void CreateProperties(CodeMemberMethod createobjectMethod, EntityDescription entity, CodeTypeDeclaration entityClass, OrmCodeDomGeneratorSettings settings, CodeMemberMethod setvalueMethod, CodeMemberMethod copyMethod, CodeTypeDeclaration propertiesClass)
		{
