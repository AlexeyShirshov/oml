...
namespace Worm.Designer
{
	...
	/// </remarks>
	public partial class DesignerHelpKeywordHelper : DesignerHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DesignerHelpKeywordHelper.
		/// </summary>
		protected DesignerHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DesignerHelpKeywordHelper.
		/// </summary>
		public static DesignerHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DesignerHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DesignerHelpKeywordHelperBase.
		/// </summary>
		protected DesignerHelpKeywordHelperBase()
			: base() { }
