...
namespace Worm.Designer
{
	...
	/// ConnectionBuilder class to provide logic for constructing connections between elements.
	/// </summary>
	public static partial class EntityReferencesSelfTargetEntitiesBuilder
	{
		#region Accept Connection Methods
		/// <summary>
		/// Test whether a given model element is acceptable to this ConnectionBuilder as the source of a connection.
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			{ 
				...
				// {
				// }
				return CanAcceptEntityAsSource((global::Worm.Designer.Entity)candidate);
			}
			else
				return false;
		}
			...
			else // Check combinations
			{
				if (candidateSource is global::Worm.Designer.Entity)
				{
					if (candidateTarget is global::Worm.Designer.Entity)
					{
						...
						// {
						// }
						if(!CanAcceptEntityAndEntityAsSourceAndTarget(sourceEntity, targetEntity)) return false;
						if(targetEntity == null || sourceEntity == null || global::Worm.Designer.EntityReferencesSelfTargetEntities.GetLinks(sourceEntity, targetEntity).Count > 0) return false;
						return true;
					}
				}
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::Worm.Designer.Entity)
				{
					if (target is global::Worm.Designer.Entity)
					{
						global::Worm.Designer.Entity sourceAccepted = (global::Worm.Designer.Entity)source;
						global::Worm.Designer.Entity targetAccepted = (global::Worm.Designer.Entity)target;
						DslModeling::ElementLink result = new global::Worm.Designer.EntityReferencesSelfTargetEntities(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
	...
	/// Handles interaction between the ConnectionBuilder and the corresponding ConnectionTool.
	/// </summary>
	internal partial class SelfRelationConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new SelfRelationConnectAction for the given Diagram.
		/// </summary>
		public SelfRelationConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the SelfRelationConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			if(this.connectionTypes == null)
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new SelfRelationConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class SelfRelationConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the SelfRelationConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected SelfRelationConnectionTypeBase() : base() {}
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder EntityReferencesSelfTargetEntitiesBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				if(sourceShapeElement == null) throw new global::System.ArgumentNullException("sourceShapeElement");
				...
				if(targetShapeElement == null)
				{
					return EntityReferencesSelfTargetEntitiesBuilder.CanAcceptSource(sourceElement);
				}
				else
				{
					targetShapeElement = RemovePassThroughShapes(targetShapeElement);
					...
					return EntityReferencesSelfTargetEntitiesBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
				}
			}
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				DslModeling::ModelElement targetElement = targetShapeElement.ModelElement;
				if(targetElement == null) targetElement = targetShapeElement;
				EntityReferencesSelfTargetEntitiesBuilder.Connect(sourceElement, targetElement);
			}
		}
		
		private partial class SelfRelationConnectionType : SelfRelationConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the SelfRelationConnectionType with the given ConnectionBuilder.
			/// </summary>
			public SelfRelationConnectionType() : base() {}
		}
	}
}
