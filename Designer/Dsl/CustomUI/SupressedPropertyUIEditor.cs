...
namespace Worm.Designer
{
    ...
    /// editor. 
    /// </summary> 
    public class SupressedPropertyUIEditor : UITypeEditor
    {
        #region Members
            ...
            IServiceProvider provider, object value)
        {
            ...
            Entity entity = (context.Instance as SupressedProperty).Entity;

            if (entity != null)
            {
                
                // Current graph 
                IList<Property> properties = entity.Properties;
                if (properties != null)
                {
                    // Build list box 
