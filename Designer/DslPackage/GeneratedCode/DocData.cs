...
namespace Worm.Designer
{
	...
	/// </summary>
	internal partial class DesignerDocData : DesignerDocDataBase
	{
		/// <summary>
		/// Constructs a new DesignerDocData.
		/// </summary>
		public DesignerDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a Designer document in memory.
	/// </summary>
	internal abstract class DesignerDocDataBase : DslShell::ModelingDocData
	{
		...
		/// <summary>
		/// Constructs a new DesignerDocDataBase.
		/// </summary>
		protected DesignerDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
                return global::Worm.Designer.DesignerDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		{
			return new DslShell::VsValidationController(this.ServiceProvider, typeof(DesignerExplorerToolWindow));
		}
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Worm.Designer.WormModel modelRoot = null;
			...
			global::Worm.Designer.DesignerDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Worm.Designer.DesignerSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.Store, fileName, diagramFileName, schemaResolver, null /* no load-time validation */);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Worm.Designer.DesignerDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Worm.Designer.DesignerDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected virtual void OnDocumentLoaded()
		{
			...
			global::Worm.Designer.WormModel modelRoot = this.RootElement as global::Worm.Designer.WormModel;
			if (modelRoot != null)
			{
				...
				if (diagrams.Count > 0)
				{
					global::Worm.Designer.DesignerDiagram diagram = diagrams[0] as global::Worm.Designer.DesignerDiagram;
					if (diagram != null)
					{
		...
		protected override bool CanSave(bool allowUserInterface)
		{
			...
			if (allowUserInterface)
			{
				...
				if (vc.ErrorMessages.Count != 0)
				{
					...
					global::System.Windows.Forms.DialogResult result = DslShell::PackageUtility.ShowMessageBox(this.ServiceProvider, global::Worm.Designer.DesignerDomainModel.SingletonResourceManager.GetString(errorMsg), VSShellInterop::OLEMSGBUTTON.OLEMSGBUTTON_YESNO, VSShellInterop::OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_SECOND, VSShellInterop::OLEMSGICON.OLEMSGICON_WARNING);
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Worm.Designer.WormModel modelRoot = (global::Worm.Designer.WormModel)this.RootElement;
			...
			if (diagrams.Count > 0 && (!saveAs || this.diagramDocumentLockHolder == null))
			{
				...
				if (diagram != null)
				{
					...
					try
					{
						...
						global::Worm.Designer.DesignerSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Worm.Designer.DesignerSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Worm.Designer.DesignerDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Worm.Designer.DesignerSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				...
				if (modelRoot != null)
				{
					modelFile = global::Worm.Designer.DesignerSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
