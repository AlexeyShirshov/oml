...
namespace Worm.Designer
{
	...
	/// </summary>
	internal partial class DesignerDocView : DesignerDocViewBase
	{
		/// <summary>
		/// Constructs a new DesignerDocView.
		/// </summary>
		public DesignerDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DesignerDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new DesignerDocView.
		/// </summary>
		protected DesignerDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			global::System.Collections.ObjectModel.ReadOnlyCollection<global::Worm.Designer.DesignerDiagram> diagrams = this.DocData.Store.ElementDirectory.FindElements<global::Worm.Designer.DesignerDiagram>();
			if (diagrams.Count > 0)
			{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Worm.Designer.DesignerToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Worm.Designer.DesignerToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.DesignerDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Worm.Designer.DesignerHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Worm.Designer.DesignerHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Worm.Designer.DesignerHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
