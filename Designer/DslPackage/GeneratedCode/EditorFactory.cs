...
namespace Worm.Designer
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.DesignerEditorFactoryId)]
	internal partial class DesignerEditorFactory : DesignerEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new DesignerEditorFactory.
		/// </summary>
		public DesignerEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DesignerEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected DesignerEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new DesignerDocData(this.ServiceProvider, typeof(DesignerEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new DesignerDocView(docData, this.ServiceProvider);
		}
	}
}
