...
namespace Worm.Designer
{
	...
	/// </summary>
	internal partial class DesignerCommandSet : DesignerCommandSetBase
	{
		/// <summary>
		/// Constructs a new DesignerCommandSet.
		/// </summary>
		public DesignerCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class DesignerCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new DesignerCommandSetBase.
		/// </summary>
		protected DesignerCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewDesignerExplorerCommand,
		...
		{
			DesignerExplorerToolWindow explorer = this.DesignerExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentDesignerDocData != null && this.CurrentDesignerDocData.Store != null)
			{
				this.CurrentDesignerDocData.ValidationController.Validate(this.CurrentDesignerDocData.Store, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentDesignerDocData != null && this.CurrentDesignerDocData.Store != null)
			{
				...
				this.CurrentDesignerDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected DesignerDocData CurrentDesignerDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as DesignerDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected DesignerDocView CurrentDesignerDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as DesignerDocView;
			}
		}
		...
		/// </summary>
		protected DesignerExplorerToolWindow DesignerExplorerToolWindow
		{
			get
			{
				DesignerExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(DesignerExplorerToolWindow), true) as DesignerExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				DesignerExplorerToolWindow explorerWindow = this.DesignerExplorerToolWindow;
